  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <header className="mb-10">
        <h1 className="text-3xl font-bold tracking-tight mb-2">Knowledge Base Management</h1>
        <p className="text-[var(--text-secondary)] text-sm">Upload and index your documents into the pgvector knowledge base.</p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          {status && (
            <div className={`p-6 rounded-2xl flex items-center gap-4 ${status.type === "success" ? "bg-green-500/5 border border-green-500/20 text-green-500" : "bg-red-500/5 border border-red-500/20 text-red-500"}`}>
        ...
        <div className="space-y-6">
          <div className="bg-[var(--glass-bg)] border border-[var(--border-primary)] rounded-2xl p-6 shadow-sm">
            ...
            <p className="text-xs text-[var(--text-secondary)] leading-relaxed">
              Documents are processed using Sentence Transformers (all-MiniLM-L6) and stored in pgvector for semantic retrieval.
            </p>
          </div>
        </div>
      </div>
